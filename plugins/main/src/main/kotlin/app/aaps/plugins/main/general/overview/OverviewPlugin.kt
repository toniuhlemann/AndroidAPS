            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                ...
                addPreference(
                    AdaptiveSwitchPreference(
                        ctx = context, booleanKey = BooleanKey.OverviewShowFuseMealButton,
                        title = app.aaps.core.ui.R.string.overview_show_fuse_meal_button,
                        summary = app.aaps.core.ui.R.string.overview_show_fuse_meal_button_summary,
                    )
                )
