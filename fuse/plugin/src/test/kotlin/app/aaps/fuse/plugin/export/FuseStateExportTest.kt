...
class FuseStateExportTest {
    ...
    private val cfg = FuseCycleRunner.Config(
        ...
        driveLowerQuantilePct = 50, tailGuardEnabled = false, conditionalTailEnabled = true, markerAuthorisesLow = false, tailFloorMgdl = 70.0, tailRecoveryU = 0.0, fastRestraintEnabled = true,
    )
